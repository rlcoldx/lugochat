document.addEventListener("DOMContentLoaded", (event) => {
    ...
    var lugochat_icon = '<div id="lugochat_icon"><div class="lugochat_floatmain"><div class="lugochat_icon_content"><img src="http://localhost/lugochat/view/widget/icone.png" id="botTitleBar" alt="Avatar"></em></div></div></div></div>';
    var lugochat_content = '<div id="lugochat_content"><iframe id="lugochat_frame" scrolling="no" width="100%" height="100%" style="border:none; margin: 0;" src="http://localhost/lugochat/widget?cc=0NfEBa8i0X9l" title="Atendimento 24h" description="Atendimento 24h"></iframe></div>';
