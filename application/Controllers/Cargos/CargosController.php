...
{	
  public function index($params)
  {
    ...
    $empresa = $_SESSION['busca_perfil_empresa'] ?? null;
  ...
  public function criar($params)
  {
    ...
    // Verifica se tem permissão para criar cargos
  ...
  public function editar($params)
  {
    ...
    // Verifica se tem permissão para editar cargos
  ...
  public function remover($params)
  {
    ...
    // Verifica se tem permissão para remover cargos
    $this->requirePermission('cargos_remover');
