...
$router->get("/reservas/check/pagamento", "ReservaController:check_reservas_pagamento");
...
$router->get("/reservas/check-expiradas", "ReservaController:check_reservas_expiradas");